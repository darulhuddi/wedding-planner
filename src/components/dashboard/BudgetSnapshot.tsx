...
export const BudgetSnapshot: React.FC<BudgetSnapshotProps> = ({
  ...
  return (
    <div className="w-full max-w-full box-border bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-7 border border-beige-300 shadow-card flex flex-col justify-between space-y-6">
      ...
      <button
        type="button"
        onClick={onViewBudget}
        className="w-full py-3 px-4 rounded-xl bg-ivory-100 hover:bg-burgundy-50 border border-beige-300 hover:border-burgundy-200 text-burgundy font-semibold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all cursor-pointer shadow-2xs"
      >
