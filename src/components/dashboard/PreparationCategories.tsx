        ...
        {modulesProgress.map((mod) => {
          ...
          return (
            <div
              ...
              className={`p-3.5 rounded-xl border transition-all duration-200 cursor-pointer flex items-center justify-between min-h-touch gap-2 ${
                isDone
            ...
            >
              ...
              <div className="shrink-0">
                {isDone ? (
                  <span className="inline-flex items-center gap-1 text-[10px] font-semibold text-emerald-800 bg-emerald-100/80 px-2 py-0.5 rounded-md border border-emerald-200 whitespace-nowrap">
                    <span>Selesai</span>
                    <Check className="w-3 h-3 stroke-[3]" />
                  </span>
                ) : isInProgress ? (
                  <span className="inline-flex items-center gap-1 text-[10px] font-semibold text-amber-800 bg-amber-100/80 px-2 py-0.5 rounded-md border border-amber-200 whitespace-nowrap">
                    <span>Dalam proses · {mod.completedTasks}/{mod.totalTasks}</span>
                  </span>
                ) : (
                  <span className="inline-flex items-center gap-1 text-[10px] font-medium text-charcoal-400 bg-white px-2 py-0.5 rounded-md border border-beige hover:text-burgundy whitespace-nowrap">
