-- Migration: Fix Reset User Wedding Planning RPC with text[] for completed_categories
-- Ensures completed_categories uses ARRAY[]::text[] matching PostgreSQL column type.
...
BEGIN
    ...
    -- 4. Reset field planning pada row public.workspaces (ROW WORKSPACE TIDAK DIHAPUS)
    -- Menjamin orders, payments, entitlements, dan commercial history tetap utuh.
